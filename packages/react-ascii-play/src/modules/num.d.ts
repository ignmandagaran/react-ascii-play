export function mapNum(v: number, inA: number, inB: number, outA: number, outB: number): number;
...
export function smootherstepNum(edge0: number, edge1: number, t: number): number;
